...
function makeNewsLines() {
  return [
    // v4.6.1: ALL three news lines revert to canvas truncation (squeeze
    // to maxWidth). 2-line wrap was making the filler text in the
    // editor read as broken across multi-line stacks at design time.
    // The wrap stays available on blank-slate + stat-card when the
    // headline pill is toggled — see render-time override.
